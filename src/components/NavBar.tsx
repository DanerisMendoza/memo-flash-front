        ...
        <AppBar>
          <Toolbar>
            ...
            {USER_DETAILS.role.length > 0 ? (
              // logged in
              <>
                <Box sx={{ flexGrow: 1, display: "flex",marginLeft:'1rem', gap:'0.5rem' }}>
                ...
                <IconButton
                  ...
                  style={{ color: "white" }}
                >
                  <p className="p-2">{USER_DETAILS.name.split(" ")[0]}</p>
                  {USER_DETAILS.profile_pic_path != "" ? (
                    <Avatar
                      alt="Remy Sharp"
                      src={(USER_DETAILS as any).profile_pic}
                      className="bg-white "
                    />
                  ) : (
                ...
                >
                  <MenuItem onClick={() => HandleSettings("logout")}>
                    Logout
                  </MenuItem>
                </Menu>
              </>
              ...
              // not logged in
              <Box className="w-screen flex flex-row justify-end gap-1">
                <Button
                  variant="contained"
                  onClick={() => Login()}
                  sx={{
